...
export async function initSite() {
    ...
    const content = new Content(config.web.title, config.server.version, config.web.navigation, config.web.downloads, config.server.ip, config.web.staff)
